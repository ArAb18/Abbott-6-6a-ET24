Public Class Form1
    ...
    Sub Rellenar()
        txt_idlibro.Text = DGVlibro.CurrentRow.Cells(0).Value
        txt_genero.Text = DGVlibro.CurrentRow.Cells(1).Value
        txt_editorial.Text = DGVlibro.CurrentRow.Cells(3).Value
        txt_autor.Text = DGVlibro.CurrentRow.Cells(4).Value
    End Sub
    ...
    Private Sub btn_Agregar_Click(sender As Object, e As EventArgs) Handles btn_Agregar.Click
        ...
        Dim conex As New SqlConnex("biblioteca")
        Try
            sql = $"INSERT INTO libro (id_libro, genero_libro, cant_pags, editorial, autor)
                   VALUES ({txt_idlibro.Text}, '{txt_genero.Text}','{txt_cantpags.Text}', '{txt_editorial.Text}', '{txt_autor.Text}');"
            conex.EjecutarSQL(sql)
