Public Class Form1
    ...
    Sub Rellenar()
        txt_iddatos.Text = DGV_GYM.CurrentRow.Cells(0).Value
    ...
    Private Sub btn_insertar_Click(sender As Object, e As EventArgs) Handles btn_insertar.Click
        ...
        Dim conex As New SqlConnex("gimnasio")
        Try
            sql = $"INSERT INTO datos (id_dato, tipo_ejercicio , repeticiones, peso_repeticiones, semana)
                   VALUES ({txt_iddatos.Text},'{txt_ejercicio.Text}', {txt_reps.Text},{txt_peso.Text}, {txt_semana.Text});"
            conex.EjecutarSQL(sql)
            conex.Dispose()
